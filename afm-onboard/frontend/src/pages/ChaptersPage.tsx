    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="glass rounded-xl px-4 py-3">
          <div className="text-xs text-white/50 mb-1">Всего курсов</div>
          <div className="text-2xl font-semibold text-white">{courses.length}</div>
        </div>
        <div className="glass rounded-xl px-4 py-3">
          <div className="text-xs text-white/50 mb-1">В процессе</div>
          <div className="text-2xl font-semibold text-sky-400">{inProgressCourses}</div>
        </div>
        <div className="glass rounded-xl px-4 py-3">
          <div className="text-xs text-white/50 mb-1">Завершено</div>
          <div className="text-2xl font-semibold text-emerald-400">{completedCourses}</div>
        </div>
        <div className="glass rounded-xl px-4 py-3">
          <div className="text-xs text-white/50 mb-1">Средний балл</div>
      ...
      {courses.length > 0 && (
        <div className="glass rounded-xl px-5 py-4">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm font-medium text-white/80">Общий прогресс обучения</span>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-semibold text-white">Мои курсы</h2>
          <span className="text-xs text-white/50">{courses.length} курсов доступно</span>
        </div>

        {courses.length === 0 ? (
          <div className="glass rounded-2xl py-16 text-center">
            <div className="text-4xl mb-3">📚</div>
            <div className="text-white/60 text-sm">Курсы пока не назначены</div>
            <div className="text-white/40 text-xs mt-1">Обратитесь к администратору</div>
          </div>
        ) : (
