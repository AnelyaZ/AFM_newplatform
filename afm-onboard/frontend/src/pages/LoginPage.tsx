    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-md px-4">
        ...
        <div className="mb-6 text-center">
          ...
          <div className="text-[11px] tracking-[0.35em] text-gray-500 text-white/70">QARJILYQ MONITORING AGENTTIGI</div>
          {/* Заголовок с названием убран по просьбе: оставляем только форму входа */}
        </div>

        <div className="glass rounded-2xl p-5">
          <div className="mb-3 text-center text-lg font-semibold text-white">Вход в систему</div>
          ...
          <p className="mt-4 text-center text-sm text-white/70">
            <Link className="text-sky-300 underline hover:text-sky-200" to="/forgot-password">Забыли пароль?</Link>
          </p>
          <p className="mt-2 text-center text-sm text-gray-600 text-white/70">
            Нет аккаунта? <Link className="text-sky-300 underline hover:text-sky-200" to="/register">Регистрация</Link>
          </p>
        </div>
